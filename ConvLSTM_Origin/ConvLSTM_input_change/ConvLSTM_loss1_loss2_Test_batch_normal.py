...
# Set up logging
logging.basicConfig(filename='convlstm_improved_weight_batch_normal.txt', level=logging.INFO, format='%(asctime)s - %(message)s')
...
model_path = "convlstm_model_improved_weight_batch_normal_64.h5"
